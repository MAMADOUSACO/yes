...
export default function ComponentsShowcase() {
  ...
  return (
    <div className="container mx-auto p-8">
      <h1 className="text-4xl font-bold mb-12">UI Components Showcase</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card>
              ...
              <CardContent className="space-y-6">
                <div>
                  <h3 className="font-medium mb-2">Volume: {volumeValue[0]}%</h3>
                  <Slider
                    value={volumeValue}
                ...
                <div>
                  <h3 className="font-medium mb-2">Opacity: {Math.round(opacityValue[0] * 100)}%</h3>
                  <Slider
                    value={opacityValue}
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div>
                  <h3 className="font-medium mb-2">Primary Variant</h3>
                  <Slider
                    variant="primary"
                    defaultValue={[60]}
                    showValueLabel
                ...
                <div>
                  <h3 className="font-medium mb-2">Accent Variant (Small)</h3>
                  <Slider
                    variant="accent"
                    size="sm"
                    defaultValue={[40]}
                ...
                <div>
                  <h3 className="font-medium mb-2">Success Variant (Large)</h3>
                  <Slider
                    variant="success"
                    size="lg"
                    defaultValue={[80]}
                ...
                <div>
                  <h3 className="font-medium mb-2">Warning & Danger</h3>
                  <Slider
                    variant="warning"
                    thumbVariant="danger"
                    defaultValue={[30]}
              ...
              <div className="space-y-4">
                ...
                <div className="mt-8">
                  <h3 className="font-medium mb-2">
                    Value Limited to Range Min: {rangeValue[0]}
                  </h3>
                  <Slider
                    min={rangeValue[0]}
                    max={100}
              ...
              <CardContent>
                <Tabs defaultValue="day" variant="underline">
                  <TabsList variant="underline">
                    <TabsTrigger value="day" variant="underline">Day</TabsTrigger>
                    <TabsTrigger value="week" variant="underline">Week</TabsTrigger>
                    <TabsTrigger value="month" variant="underline">Month</TabsTrigger>
                  </TabsList>
                  <TabsContent value="day" className="p-4 border rounded-md mt-2">
                    <h3 className="font-semibold mb-2">Daily View</h3>
                    <p>View detailed hourly breakdown.</p>
                  </TabsContent>
                  <TabsContent value="week" className="p-4 border rounded-md mt-2">
                    <h3 className="font-semibold mb-2">Weekly View</h3>
                    <p>See your entire week at a glance.</p>
                  </TabsContent>
                  <TabsContent value="month" className="p-4 border rounded-md mt-2">
            ...
            <Card>
              ...
              <CardContent>
                <Tabs defaultValue="all" variant="pill">
                  <TabsList variant="pill" className="bg-slate-100 dark:bg-slate-800 p-1 rounded-full">
                    <TabsTrigger value="all" variant="pill">All</TabsTrigger>
                    <TabsTrigger value="active" variant="pill">Active</TabsTrigger>
                    <TabsTrigger value="completed" variant="pill">Completed</TabsTrigger>
                  </TabsList>
              ...
              <CardContent>
                <Tabs defaultValue="design" variant="outline">
                  <TabsList variant="outline" fullWidth>
                    <TabsTrigger value="design" variant="outline" fullWidth>Design</TabsTrigger>
                    <TabsTrigger value="code" variant="outline" fullWidth>Code</TabsTrigger>
                    <TabsTrigger value="preview" variant="outline" fullWidth>Preview</TabsTrigger>
                  </TabsList>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Select colors using hexadecimal format
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Select colors using RGB values
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex flex-col gap-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Different sizes and presentation styles
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Tabs defaultValue="sizes" className="w-full">
                  ...
                  <TabsContent value="variants" className="space-y-6 pt-4">
                    ...
                    <div>
                      <h3 className="font-medium mb-2">Popover Style (for illustrative purposes)</h3>
                      <ColorPicker
                        format="hex"
                        color="#db2777"
                        onChange={() => {}}
